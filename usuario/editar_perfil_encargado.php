...
<header>
    ...
    <nav>
        <ul>
            <li><a href="..\encargado/bienvenido_encargado.php">Volver</a></li>
...
<body>
    ...
    <div>
        <ul class="migas-de-pan">
            ...
            <li class="migas-de-pan-item"><a href="../encargado/bienvenido_encargado.php" class="migas-de-pan-link">Encargado</a></li>
